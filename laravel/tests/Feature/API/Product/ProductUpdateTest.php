...
class ProductUpdateTest extends TestCase
{
    ...
    public function test_if_input_is_valid_then_updates_and_returns_product(callable $inputCallback): void
    {
        ...
        $response->assertOk();
        $this->assertModelIsUpdated($updatedProduct, $input);
        $response->assertJson([
            'data' => [
                'id'         => $updatedProduct->id,
                'title'      => $updatedProduct->title,
                'price'      => $updatedProduct->price,
                'created_at' => $updatedProduct->created_at->format('Y-m-d H:i:s'),
                'updated_at' => $updatedProduct->updated_at->format('Y-m-d H:i:s'),
                'currency' => [
                    'id'   => $updatedProduct->currency->id,
                    'code' => $updatedProduct->currency->code,
                ],
            ],
        ]);
    }
